...
{
    [BepInPlugin("Slam.TerminalPlus", "TerminalPlus", "0.1.0")]
    public class PluginMain : BaseUnityPlugin
    {
        internal static ManualLogSource mls;
        internal static Harmony harmony = new Harmony("Slam.TerminalPlus");
        private static PluginMain instance;
        internal static ConfigFile configFile = new ConfigFile(Path.Combine(Paths.ConfigPath, "TerminalPlus.cfg"), saveOnInit: true);
