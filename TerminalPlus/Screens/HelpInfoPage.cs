...
namespace TerminalPlus
{
    partial class Nodes
    {
        ...
        public string HelpInfoPage()
        {
            ...
            pageChart2.AppendLine("        <size=120%>‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾          ");
            pageChart2.AppendLine("</size>>\"ID\" <size=90%><color=yellow>(LOWEST first)  <color=red>(HIGHEST first)</color></color></size>");
            pageChart2.AppendLine("Sorts moons by internal ID; the default setting<line-height=60%>\n</line-height>");
            pageChart2.AppendLine(">\"NAME\" <size=90%><color=yellow>('A' first)  <color=red>('Z' first)</color></color></size>");
            pageChart2.AppendLine("Sorts moons alphabetically by name.<line-height=60%>\n</line-height>");
            pageChart2.AppendLine(">\"PREFIX\" <size=90%><color=yellow>(LOWEST first)  <color=red>(HIGHEST first)</color></color></size>");
            pageChart2.AppendLine("Sorts moons by prefix (number left of the name).<line-height=60%>\n</line-height>");
            pageChart2.AppendLine(">\"GRADE\" <size=90%><color=yellow>(WORST first)  <color=red>(BEST first)</color></color></size>");
            pageChart2.AppendLine("Sorts moons by hazard level / grade (\"GD\").<line-height=60%>\n</line-height>");
            pageChart2.AppendLine(">\"PRICE\" <size=90%><color=yellow>(LOWEST first)  <color=red>(HIGHEST first)</color></color></size>");
            pageChart2.AppendLine("Sorts moons by price.<line-height=60%>\n</line-height>");
            pageChart2.AppendLine(">\"WEATHER\" <size=90%><color=yellow>(CLEAR first)  <color=red>(ECLIPSED first)</color></color></size>");
            pageChart2.AppendLine("Sorts moons by current weather conditions.<line-height=60%>\n</line-height>");
            pageChart2.AppendLine(">\"DIFFICULTY\" <size=90%><color=yellow>(EASIEST first)  <color=red>(HARDEST first)</color></color></size>");
            pageChart2.AppendLine("Sorts moons by calculated difficulty.<line-height=60%>\n</line-height>");
